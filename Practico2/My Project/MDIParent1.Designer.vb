...
Partial Class MDIParent1
    ...
    Private Sub InitializeComponent()
        ...
        ' MenuStrip
        ' 
        MenuStrip.Items.AddRange(New ToolStripItem() {FileMenu, EditMenu, ViewMenu, ToolsMenu, WindowsMenu, HelpMenu, PequeñoFormularioToolStripMenuItem})
    ...
    Friend WithEvents PequeñoFormularioToolStripMenuItem As ToolStripMenuItem
